...
```
Documenta ambas observaciones: la diferencia entre las dos respuestas te dice cuándo se lee el archivo y cuándo se ejecuta el proceso.
Con el volumen, los cambios que se hacen en el EC2, se ven reflejados automaticament en el contenedor. Los cambios tambien permanecen despues de hace reiniciar el contenedor
```